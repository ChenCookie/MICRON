...
## Brain Tumors Example

We prepared the IMC dataset generated by Karimi et al. for use with the MICRON model. We also provide the data file format required for the model input. The dataset can be accessed at the following link: https://doi.org/10.5281/zenodo.20032681. 
...
```
@article{chen2026micron,
  title={MICRON learns outcome-associated representations of spatial immune microenvironments},
  author={Chen, Chi-Jane and George, Betsy and Dhawka, Luvna and Evangelista, Baggio and Stanley, Natalie},
  journal={bioRxiv},
  year={2026}
}
