...
We prepared the IMC dataset generated by Karimi et al. for use with the MICRON model. We also provide the data file format required for the model input. The dataset can be accessed at the following link: https://doi.org/10.5281/zenodo.19474557. 
